    ...
    def process_image(self):
        ...
        if choice == "1" and algo == "DES":
            try:
                ...
                end_des=time.time()
                print(f"The Time Taken to encrypt DES is {end_des-start_des}")
            ...
            try:
                ...
                end_des=time.time()
                print(f"The Time Taken to decrypt DES is {end_des-start_des}")
            ...
            try:
                ...
                end_des=time.time()
                print(f"The Time Taken to encrypt 3-DES is {end_des-start_des}")
                messagebox.showinfo("Success", "Encryption successful!")
            except Exception as e:
                messagebox.showerror("Error", f"Encryption failed: {e}")
            ...
            try:
                ...
                end_des=time.time()
                print(f"The Time Taken to decrypt 3-DES is {end_des-start_des}")
                messagebox.showinfo("Success", "Decryption successful!")
            except Exception as e:
                messagebox.showerror("Error", f"Decryption failed: {e}")
